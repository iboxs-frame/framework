...
use iboxs\initializer\Error;
use iboxs\initializer\RegisterService;
...
class App extends Container
{
    ...
    protected $bind = [
        ...
        'view'                    => View::class,
        'iboxs\DbManager'         => Db::class,
        'iboxs\LogManager'        => Log::class,
        'iboxs\CacheManager'      => Cache::class,
    ...
    {
        $this->iboxsPath   = realpath(dirname(__DIR__)) . DIRECTORY_SEPARATOR;
        ...
        $this->instance('iboxs\Container', $this);
    }
