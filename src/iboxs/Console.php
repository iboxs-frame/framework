...
use iboxs\console\command\Clear;
use iboxs\console\command\Help;
use iboxs\console\command\Help as HelpCommand;
use iboxs\console\command\Lists;
use iboxs\console\command\make\Command as MakeCommand;
use iboxs\console\command\make\Controller;
use iboxs\console\command\make\Event;
use iboxs\console\command\make\Listener;
use iboxs\console\command\make\Middleware;
use iboxs\console\command\make\Model;
...
use iboxs\console\command\RunServer;
use iboxs\console\command\ServiceDiscover;
use iboxs\console\command\VendorPublish;
use iboxs\console\command\Version;
